<template>
    ...
    <div class="grid lg:flex pt-24 lg:pt-0 pb-12">
        ...
        <div class="w-full lg:w-3/5 bg-second_p flex flex-col justify-center lg:px-32">
            ...
            <p class="px-3 lg:px-0 pb-8 text-center lg:text-start">
                <span class="font-semibold text-4xl md:text-6xl 2xl:text-8xl">{{ $t('candle_title').first }}</span>
                <span class="text-primary_p font-semibold text-4xl md:text-6xl 2xl:text-8xl">{{
                    $t('candle_title').second }}</span>
                <span class="text-black_p font-semibold text-4xl md:text-6xl 2xl:text-8xl">{{
                    $t('candle_title').therciary }}</span>
                <span class="font-special text-primary_p text-5xl md:text-7xl 2xl:text-9xl">{{ $t('candle_title').fourth
                    }}</span>
            </p>
    ...
    <div class="bg-cream_p py-20">
        <div class="mx-auto flex flex-col xl:px-16 pb-12">
            ...
            <p class="pb-4 px-8 xl:px-0 font-medium text-3xl tracking-wide w-full xl:w-1/2 text-black_p">
