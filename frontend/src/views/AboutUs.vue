    ...
    <div class="bg-primary_p xl:h-96">
        <div class="grid xl:grid-cols-2 gap-6">
            <div class="p-8 md:p-16">
                <h1 class="font-semibold text-5xl md:text-7xl text-second_p">Let it cool completely to maximizing the life of your candle.</h1>
            </div>
            <div class="xl:w-3/4 px-8 md:px-16 xl:px-0 pb-16 flex items-end">
                <p class="text-second_p font-regular text-2xl md:text-4xl">More than 10 times experiments were carried out to find the fragance in accordance with nature to the point of having to stay overnight in the dark.</p>
            </div>
        </div>
    </div>
