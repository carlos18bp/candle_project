<template>
  ...
  <div class="fixed inset-0 flex justify-end z-50" v-if="visible">
    ...
    <div
      ref="cart"
      class="relative bg-white h-full w-2/5 shadow-lg flex flex-col z-60"
    >
      <!-- Cart Header -->
      <div class="flex justify-between items-center p-10">
        ...
        <XMarkIcon
          @click="closeCart()"
          class="text-gray-500 cursor-pointer w-6 h-6"
        >
        </XMarkIcon>
      </div>
      ...
      <div
        ...
        class="p-10 space-y-4 flex-1 overflow-y-auto"
      >
        <CartProduct
