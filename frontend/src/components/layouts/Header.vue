    ...
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      <div class="flex flex-1">
        ...
        <div class="flex lg:hidden">
          ...
          <button type="button" class="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-black_p"
      ...
      <div class="hidden lg:flex lg:flex-1 justify-end">
            ...
            <MenuItems
              ...
              <div class="py-1">
                ...
                <a @click="handleLanguage('en')"
                  :class="[active ? 'bg-gray-100 text-black_p' : 'text-gray-700', 'block px-4 py-2 text-sm cursor-pointer']">{{
        ...
        <!-- Enlace de contacto -->
        <RouterLink :to="{ name: 'contact' }" type="button"
          ...
          <div class="mt-6 flow-root">
            <div class="-my-6 divide-y divide-gray-500/10">
              ...
              <a v-for="item in mobileLinks" :key="item.name" :href="item.href"
                :class="{ 'bg-gray-100 text-black_p': isActive(item.name), 'text-gray-900': !isActive(item.name) }"
