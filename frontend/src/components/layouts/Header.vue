            ...
            <div class="flex flex-1">
                <div class="hidden lg:flex lg:gap-x-12">
                    ...
                    <RouterLink :to="{ name: 'about_us' }"
                        class="text-sm uppercase font-regular leading-6 text-black_p">
                        {{ $t("about") }}
                    </RouterLink>
                ...
                <div class="flex lg:hidden">
                    ...
                    <button type="button"
                        class="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-black_p"
            ...
            <div class="hidden lg:flex lg:flex-1 justify-end">
                <div class="relative cursor-pointer">
                    ...
                    <span @click="showShoppingCart = true" v-if="totalCartProducts > 0"
                        class="absolute top-0 left-1/2 bg-primary_p text-white rounded-full text-xs size-5 flex items-center justify-center shadow-lg m-2 ml-0">
                        {{ totalCartProducts }}
                    </span>
                </div>
                ...
                <Menu as="div" class="relative inline-block text-left pr-4 uppercase">
                    <div>
                        <MenuButton
                            class="inline-flex w-full justify-center gap-x-1.5 rounded-md px-3 py-2 text-sm uppercase font-medium text-black_p">
                            {{ $t("language").language }}
                    ...
                    <transition enter-active-class="transition ease-out duration-100"
                        ...
                        <MenuItems
                            class="font-medium absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                            <div class="py-1">
                ...
                <RouterLink :to="{ name: 'contact' }"
                    class="rounded-full px-3.5 py-2 text-sm uppercase font-medium text-black_p ring-1 ring-black_p hover:bg-black_p hover:text-second_p">
                    {{ $t("contact") }}
                </RouterLink>
            </div>
        </nav>
        ...
        <Dialog as="div" class="lg:hidden" @close="mobileMenuOpen = false" :open="mobileMenuOpen">
            <DialogPanel>
                ...
                <div ref="navbarMobile"
                    class="fixed inset-y-0 left-0 z-30 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
