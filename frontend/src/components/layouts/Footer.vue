      ...
      <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-8 lg:px-8">
              ...
              <div class="mt-10 md:mt-0">
                ...
                <ul role="list" class="mt-6 space-y-4">
                  <li class="cursor-pointer" v-for="item in legal" :key="item.name">
                    <a @click="openTerms" class="text-sm font-regular leading-6 text-second_p hover:text-primary_p">{{ item.name }}</a>
                  </li>
                </ul>
              </div>
        ...
        <div class="mt-16 border-t border-gray_p pt-8 sm:mt-20 lg:mt-24 grid grid-cols-2 gap-4">
          ...
          <div class="grid grid-cols-2 gap-2">
            ...
            <img class="w-auto h-10" src="@/assets/images/logo_pwc.png" alt="Logo of Páginas Webs Colombia Oficial.">
          </div>
        </div>
      </div>
    </footer>
